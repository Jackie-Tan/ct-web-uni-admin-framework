...
Package.on_use(function (api, where) {
  ...
  api.add_files(['route/health.js', 'route/metrics.js', 'route/upload.js', 'route/project.js', 'route/s3upload.js', 'route/ssa-upload.js', 'route/shop-upload.js', 'route/iris-upload.js'], 'server');
});
